# Generated by Django 3.1.3 on 2021-04-24 04:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('is_active', models.IntegerField(default=1)),
                ('added_by_merchant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.merchant')),
            ],
        ),
        migrations.CreateModel(
            name='ProductVariant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('is_active', models.IntegerField(default=1)),
                ('category_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.category')),
            ],
        ),
        migrations.CreateModel(
            name='Staff',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_variant_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.productvariant')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('is_active', models.IntegerField(default=1)),
                ('product_review_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.productreview')),
                ('user_voting_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.customer')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='productreview',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.customer'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.IntegerField(default=1)),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.products')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.customer')),
            ],
        ),
        migrations.CreateModel(
            name='ProductMedia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.customerorder')),
            ],
        ),
        migrations.AddField(
            model_name='merchant',
